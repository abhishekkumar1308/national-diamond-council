<template>
  <div v-if="isVisible" class="bg-orange-100 border border-orange-400 text-orange-700 px-4 py-3 rounded relative" role="alert">
...
export default {
  ...
  props: {
    ...
    message: {
      type: String,
      default: 'Something not ideal might be happening.'
    },
    autoCloseTime: {
      type: Number,
