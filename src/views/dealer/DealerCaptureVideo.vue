...
export default {
  ...
  setup() {
    ...
    const display_phone = computed(() => authStore.dealer?.mobile || "91");
    ...
    const confirmVideo = async () => {
      ...
      await api.post("/api/v1.0/media/upload-video", formData, { headers: { "Content-Type": "multipart/form-data" } });
      closeCameraModal();
